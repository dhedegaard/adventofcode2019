...
#[wasm_bindgen]
pub fn day13_input() -> String {
  day13::raw_input()
}
#[wasm_bindgen]
pub fn day13_part1(input: &str) -> String {
  day13::part1(&mut day13::parse_input(input)).to_string()
}
#[wasm_bindgen]
pub fn day13_part2(input: &str) -> String {
  day13::part2(day13::parse_input(input)).to_string()
}
...
#[wasm_bindgen]
pub fn day15_input() -> String {
  day15::raw_input()
}
#[wasm_bindgen]
pub fn day15_part1(input: &str) -> String {
  day15::part1(day15::parse_input(input)).to_string()
}
#[wasm_bindgen]
pub fn day15_part2(input: &str) -> String {
  day15::part2(day15::parse_input(input)).to_string()
}
...
#[wasm_bindgen]
pub fn day21_input() -> String {
  day21::raw_input()
}
#[wasm_bindgen]
pub fn day21_part1(input: &str) -> String {
  day21::part1(&mut day21::parse_input(input)).to_string()
}
#[wasm_bindgen]
pub fn day21_part2(input: &str) -> String {
  day21::part2(&mut day21::parse_input(input)).to_string()
}
